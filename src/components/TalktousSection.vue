        ...
        <form @submit.prevent="handleSubmit">
          <div class="flex flex-col md:flex-row gap-10">
            <div class="w-4xl">
              ...
              <!-- First row -->
              <div class="flex flex-col md:flex-row gap-5 my-3">
                <div>
                  <BaseInput 
                    label="first name" 
                    v-model="form.name"
                    input-class="w-100 md:w-64 rounded-full py-5 focus:border-[#72C18B]" 
              ...
              <div class="py-7">
                <BaseTextarea 
                  ...
                  TextareaClass=" w-100 md:w-full rounded-xl resize-none py-5 focus:border-[#72C18B]" 
              ...
              <div>
                ...
                type="submit"
                  label="Submit"
                  button-class="bg-blue-600 px-10 py-2 text-white rounded-full"
                />
              </div>
            </div>

            <div>
              <img :src="messagesimg" alt="messgae image" class="" />
            </div>
          </div>
        </form>
      </div>
